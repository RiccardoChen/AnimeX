...
public class DatabaseIntegrationTest extends BaseIntegrationTest {
    ...
    public void testH2DatabaseConnection() {
        ...
        Integer result = jdbcTemplate.queryForObject("SELECT COUNT(*) FROM INFORMATION_SCHEMA.TABLES WHERE TABLES.TABLE_NAME = 'PROFILE_ANIME'", Integer.class);
        assertThat(result)
                .isEqualTo(1); // Verifica che la tabella CANDIDATO esista
    }
}
